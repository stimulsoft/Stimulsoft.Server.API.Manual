...
| **SetWeeklyFrequency** (StiDaysOfWeek daysOfWeek, int runAtHour = 0, int runAtMinute = 0) | Weekly launch actions in daysOfWeek day of week, runAtHour hours, runAtMinute minutes. StiDaysOfWeek it is the enumeration of days of the week, empty value (None) and value for all days of the week (All); |
