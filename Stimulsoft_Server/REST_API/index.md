...
| /1/signup | POST | [New user registration](Sign_Up.md) |
...
| /1/roles | GET | [Getting a list of roles](Roles/GET_List.md) |
| /1/roles/&lt;RoleId&gt; | GET | [Getting information about the role <RoleId>](Roles/GET_Info.md) |
| /1/roles | POST | [Creating a new role](Roles/POST_Create.md) |
| /1/roles/&lt;RoleId&gt; | PUT | [Changing information about the role <RoleId>](Roles/PUT_Edit.md) |
| /1/roles/&lt;RoleId&gt; | DELETE | [Remove a role <RoleId>](Roles/DELETE.md) |
...
| /1/schedulers | GET | [Getting a list of schedulers](Schedulers/GET_List.md) |
| /1/schedulers/&lt;SchedulerId&gt; | GET | [Getting information about the scheduler <SchedulerId>](Schedulers/GET_Info.md) |
| /1/schedulers | POST | [Creating a new scheduler](Schedulers/POST_Create.md) |
| /1/schedulers/&lt;SchedulerId&gt; | PUT | [Changing information about the scheduler <SchedulerId>](Schedulers/PUT_Edit.md) |
| /1/schedulers/&lt;SchedulerId&gt; | DELETE | [Removal of scheduler <SchedulerId>](Schedulers/DELETE.md) |
| /1/schedulers/&lt;SchedulerId&gt;/status | GET | [Getting information about the state of the scheduler <SchedulerId>](Schedulers/GET_Info_Status.md) |
| /1/schedulers/&lt;SchedulerId&gt;/status | PUT | [Setting state of scheduler <SchedulerId>](Schedulers/PUT_Edit_Status.md) |
| /1/schedulers/&lt;SchedulerId&gt;/run | PUT | [Immediate start of scheduler <SchedulerId>](Schedulers/Run.md) |
| /1/files | GET | [Getting a list of files](Files/GET_List.md) |
| /1/files/&lt;FileId&gt;/ | GET | [Downloading a file <FileId>](Files/GET_Download.md) |
| /1/files | POST | [Creating a new file](Files/POST_Create.md) |
| /1/files/&lt;FileId&gt;/ | PUT | [Appending a new chunk to file <FileId>](Files/PUT_Append.md) |
| /1/files/&lt;FileId&gt;/ | DELETE | [Removing a file <FileId>](Files/DELETE.md) |
...
| /1/reporttemplates/&lt;ReportTemplateId&gt;/run | PUT | [Build the report template and save result to another item](Report_Template/Run.md) |
| /1/reporttemplates/&lt;ReportTemplateId&gt;/duplicate | POST | [Creating a new copy of the report template in a workspace of the logged-in user.](../../Stimulsoft_Cloud/REST_API/Report_Template/POST_Duplicate.md) |
| /1/reportsnapshots | GET | [Getting a list of report snapshots](Report_Snapshot/GET_List.md) |
| /1/reportsnapshots/&lt;ReportSnapshotId&gt;/ | GET | [Getting information about the report snapshot <ReportSnapshotId>](Report_Snapshot/GET_Info.md) |
| /1/reportsnapshots | POST | [Creating a new report snapshot](Report_Snapshot/POST_Create.md) |
| /1/reportsnapshots/&lt;ReportSnapshotId&gt;/ | DELETE | [Removing a report snapshot <ReportSnapshotId>](Report_Snapshot/DELETE.md) |
| /1/reportsnapshots/&lt;ReportSnapshotId&gt;/export | PUT | [Export data from report snapshot](Report_Snapshot/Export.md) |
