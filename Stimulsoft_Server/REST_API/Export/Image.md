...
`-d "{ 'FileItemName':'Image', 'ExportSet':{ 'Ident':'Image', 'ImageType':'Png', 'ImageResolution': '200' } }" http://reports.stimulsoft.com/1/reporttemplates/a8dde8679ecb43cbbba190786a2b44f3/run`
