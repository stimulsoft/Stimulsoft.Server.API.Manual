...
`curl -X PUT -H "x-sti-SessionKey: 7cc93e33645f4e05975e3a468229c00f" -H "x-sti-DestinationItemKey: 6ad634d0764849b9801600ad8f7fe56b"`

`-d "{ 'FileItemName':'ExportReport.xlsx', 'ExportSet':{ 'Ident':'Excel2007', 'ImageQuality':'75' } }" http://reports.stimulsoft.com/1/reporttemplates/a8dde8679ecb43cbbba190786a2b44f3/run`
