...
curl -X POST -H "x-sti-SessionKey: 4ccbebaac38642b4a182d555aa09ee46" -d "{ 'Ident':'FileItem','Name':'ODC','Description':'This is a sample export to Open Document Calc', 'FileType': 'OpenDocumentCalc' }" http://reports.stimulsoft.com/1/files
...
curl -X PUT -H "x-sti-SessionKey: ea46a3c2c2084439832ea4518d8a5af2" -H "x-sti-DestinationItemKey: 6ad634d0764849b9801600ad8f7fe56b" -d "{ 'FileItemName':'Open Document Calc', 'ExportSet':{ 'Ident':'OpenDocumentCalc', 'PageRange': {}, 'ImageQuality': '100', 'ImageResolution':'200' } }" http://reports.stimulsoft.com/1/reporttemplates/a8dde8679ecb43cbbba190786a2b44f3/run
