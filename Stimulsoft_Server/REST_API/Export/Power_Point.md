...
`curl -X POST -H "x-sti-SessionKey: 4ccbebaac38642b4a182d555aa09ee46" -d "{ 'Ident':'FileItem','Name':'Power Point','Description':'This is a sample export to Power Point', 'FileType': 'PowerPoint' }" http://reports.stimulsoft.com/1/files`
...
`-d "{ 'FileItemName':'Power Point', 'ExportSet':{ 'Ident':'PowerPoint', 'PageRange': {}, 'ImageQuality':'75', 'ImageResolution': '200'} }" http://reports.stimulsoft.com/1/reporttemplates/a8dde8679ecb43cbbba190786a2b44f3/run`
